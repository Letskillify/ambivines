...
const TourPage = () => {
  ...
  style={{
    backgroundImage:
      "url('https://images.unsplash.com/photo-1472352327492-9765783b74e1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fHdpbmV8ZW58MHx8MHx8fDA%3D')",
  }}
>
  {/* Light Overlay */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        <div className="lg:col-span-7 relative">
                            <div className="aspect-[16/10] overflow-hidden rounded-[2rem] shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1472352327492-9765783b74e1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fHdpbmV8ZW58MHx8MHx8fDA%3D" alt="Vineyard" className="w-full h-full object-cover" />
                            </div>
